    ...
    <div class="col-12">
        <div class="card mb-4">
            <div class="card-header pb-0">
                <h6>Authors table</h6>
                <button class="btn btn-primary btn-sm" id="addAuthorBtn" data-bs-toggle="modal" data-bs-target="#authorModal">Ajouter acte criminel</button>
                <button class="btn btn-primary btn-sm mb-2" id="addTypeActeBtn" data-bs-toggle="modal" data-bs-target="#addTypeActeModal">Ajouter Type d'Acte</button>
...
<div class="modal fade"  id="authorModal" tabindex="-1" aria-labelledby="addActeCrimeModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addActeCrimeModalLabel">Ajouter un acte criminel</h5>
...
<div class="modal fade" id="addTypeActeModal" tabindex="-1" aria-labelledby="addTypeActeModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addTypeActeModalLabel">Add Type d'Acte</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        var addTypeActeBtn = document.getElementById('addTypeActeBtn');
        addTypeActeBtn.addEventListener('click', function() {
            var addTypeActeModal = new bootstrap.Modal(document.getElementById('addTypeActeModal'));
            addTypeActeModal.show();
        });
    });
</script>
